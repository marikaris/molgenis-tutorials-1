<template>
  <div id="mg-plugins" class="slideshow" ref="emx">
...
import config from '@/tutorials/plugins/config.json'
import slides from '@/tutorials/plugins'
...
export default {
  ...
  infos: {
    ...
    title: 'MOLGENIS Plugins',
    description: 'In this tutorial we will briefly describe the function of the MOLGENIS plugins.',
